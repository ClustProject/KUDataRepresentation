...
class TC(nn.Module):
    def __init__(self, configs, device):
        ...
        self.Wk = nn.ModuleList([nn.Linear(configs['hidden_dim'], self.num_channels) for i in range(self.timestep)])
        ...
        self.seq_transformer = Seq_Transformer(patch_size=self.num_channels, dim=configs['hidden_dim'], depth=4, heads=4, mlp_dim=64)
